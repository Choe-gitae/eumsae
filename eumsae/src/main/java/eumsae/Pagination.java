...
public class Pagination {
	   ...
	   private void calculation() {
	      ...
	      firstPageNo = ( ( (int)Math.ceil((float)pageNum / (float)pageNavSize) ) -1 ) * pageNavSize +1;
	      ...
	      hasFirstPageNav = (pageNum > 1 && pageNavSize < pageNum); 
	      hasLastPageNav = (pageNum < totalPage && lastPageNo + 1 < totalPage );       
	   }
	}
