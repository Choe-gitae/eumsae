                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single_widget_area">
                            ...
                            <p class="copywrite">
                                ...
                                <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> & Re-distributed by
                                ...
                                <nav class="navbar navbar-expand-lg justify-content-end">
                                    ...
                                    <div class="collapse navbar-collapse" id="footerNavContent">
                                        <ul class="navbar-nav ml-auto">
                                            <img src="<%=pjName%>/resources/img/core-img/logo.png" width="300" height="50" /><br />
                                        </ul>
                                    </div>
                                </nav>
                            </div>
