							...
							<div class="classynav">
								<ul>
									...
									<li><a href="#">Category</a>
										<ul class="dropdown">
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=POP">POP</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=Rock">ROCK</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=HipHop">HipHop</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=Ballad">Ballad</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=국내가요">국내가요</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=Fork">Fork</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=RnB">RnB</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=Elec">일렉트로</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=Ost">OST</a></li>
											<li><a
												href="<%=pjName%>/shop/searchLp?searchCon=genre&searchKey=트로트">트로트</a></li>
										</ul></li>
								...
								<div
									...
									<div class="login-register-btn mr-50">
										<c:if test="${login == null }">
											<a href="<%=pjName%>/user/login&RegisterPage" id="loginBtn">Login
												/ Register</a>
										</c:if>
										<c:if test="${login != null }">
									...
									<!-- Cart Button -->
									<div class="cart-btn">
										<a href="<%=pjName%>/user/cart?id=${login}"><img
											src="<%=pjName%>/resources/images/shop/cart.png"
											...
											<div class="classy-menu">
												...
												<div class="classynav">
													...
													<div
														...
														<div class="login-register-btn mr-50">
															<c:if test="${login == null }">
																<a href="<%=pjName%>/user/login&RegisterPage"
																	id="loginBtn">Login / Register</a>
															</c:if>
															<c:if test="${login != null }">
																<a href="<%=pjName%>/user/logout" id="logOutBtn">Log
																	Out</a>
															</c:if>
														</div>
