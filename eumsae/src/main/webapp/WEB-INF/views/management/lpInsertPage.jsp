		...
		<div class="content">
			...
			<div class="container-fluid pt-4 px-4">
				...
				<div class="bg-secondary rounded h-100 p-4" style="max-width: 600px">
					...
					<form action="insertLp?page=lpInsertPage" method="post"
						...
						<div class="form-floating mb-3">
							...
							</select> <label for="genre">장르</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="singer" name="singer" placeholder="가수" /> <label
								for="singer">가수</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="title" name="title" placeholder="제목" /> <label for="title">제목</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="stitle" name="stitle" placeholder="음원명" /> <label
								for="stitle">음원명</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="region" name="region" placeholder="지역" /> <label
								for="region">지역</label>
						</div>
						<div class="form-floating mb-3">
							<textarea class="form-control" placeholder="소개" id="content"
								name="content" style="height: 150px;"></textarea>
							<label for="content">소개</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="lpdate" name="lpdate" placeholder="발매일자" /> <label
								for="lpdate">발매일자</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="cnt" name="cnt" placeholder="재고" /> <label
								for="cnt">재고</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="price" name="price" placeholder="가격" /> <label for="price">가격</label>
						</div>
						<div class="mb-3">
							<label for="fjpg" class="form-label">LP 사진</label> <input
								class="form-control bg-dark" type="file" id="fjpg" name="fjpg"
								required />
						</div>
						<div class="mb-3">
							<label for="fmp3" class="form-label">LP 음원</label> <input
								class="form-control bg-dark" type="file" id="fmp3" name="fmp3" />
						</div>
