...
<html>
  ...
  <body>
    <div class="container-fluid position-relative d-flex p-0">
      ...
      <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
          <div class="alert alert-light" role="alert">LP 가격 관리 페이지</div>
          <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
              <div class="bg-secondary rounded h-100 p-4" style="max-width: 600px">
                <h6 class="mb-4">LP 검색</h6>
                <form action="searchLp?page=lpPriceUpdatePage" method="post">
            ...
            <div class="col-sm-12 col-xl-6">
              <div class="bg-secondary rounded h-100 p-4" style="max-width: 600px">
                <h6 class="mb-4">가격 변경</h6>
                <form action="updatePrice?page=lpPriceUpdatePage" method="post" >
    ...
    <script src="<%=pjName%>/resources/js/lpPriceUpdate.js"></script>
  </body>
</html>
