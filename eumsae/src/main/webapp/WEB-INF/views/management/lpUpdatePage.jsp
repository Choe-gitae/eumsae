                        ...
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-secondary rounded h-100 p-4" style="max-width: 600px">
                                ...
                                <form action="searchLp?page=lpUpdatePage" method="post">
                                    ...
                                    <input class="form-control bg-dark border-0" name="searchKey" type="search" placeholder="Search" />
                        ...
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-secondary rounded h-100 p-4" style="max-width: 600px">
                                ...
                                <form action="updateLp?page=lpUpdatePage" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control form-control-lg" id="title" name="title" placeholder="제목" /> <label for="title">제목</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control form-control-lg" id="cnt" name="cnt" placeholder="재고" /> <label for="cnt">재고</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control form-control-lg" id="price" name="price" placeholder="가격" /> <label for="price">가격</label>
                                    </div>
                                    <div class="mb-3"><label for="fjpg" class="form-label">LP 사진</label> <input class="form-control bg-dark" type="file" id="fjpg" name="fjpg" /></div>
                                ...
                                <tbody>
                                    <c:forEach var="list" items="${list}" varStatus="status">
                                        <tr>
                                            ...
                                            <td><img src="<%= pjName %>/resources/lpImg/${list.cjpg}.jpg" class="mgr-del-table-img" /></td>
                                            <td>${list.genre}</td>
                                            <td>${list.singer}</td>
                                            <td>${list.title}</td>
                                            <td>${list.stitle}</td>
