				...
				<div class="row g-4">
					...
					<div class="col-sm-12 col-xl-6">
						<div class="bg-secondary rounded h-100 p-4"
							...
							<form action="updateLp?page=lpUpdatePage" method="post"
								...
								<div class="form-floating mb-3">
									<input type="text" class="form-control form-control-lg"
										id="title" name="title" placeholder="제목" /> <label
										for="title">제목</label>
								</div>
								<div class="form-floating mb-3">
									<input type="text" class="form-control form-control-lg"
								...
								<div class="form-floating mb-3">
									<input type="text" class="form-control form-control-lg"
										id="cnt" name="cnt" placeholder="재고" /> <label for="cnt">재고</label>
								</div>
								<div class="form-floating mb-3">
									<input type="text" class="form-control form-control-lg"
										id="price" name="price" placeholder="가격" /> <label
										for="price">가격</label>
								</div>
								<div class="mb-3">
