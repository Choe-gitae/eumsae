		...
		<div class="content">
			...
			<div class="container-fluid pt-4 px-4">
				...
				<div class="bg-secondary rounded h-100 p-4" style="max-width: 600px">
					...
					<form action="registManager" method="post" name="regMgrForm">
						...
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="mid" name="mid" placeholder="아이디" /> <label
								for="floatingInput">아이디</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="pwd" name="pwd" placeholder="비밀번호" /> <label
								for="floatingInput">비밀번호</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="repwd" name="repwd" placeholder="비밀번호 확인" /> <label
								for="floatingInput">비밀번호 확인</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="name" name="name" placeholder="이름" /> <label
						...
						<div class="form-floating mb-3">
							<input type="text" class="form-control form-control-lg"
								id="floatingInput" name="addr" placeholder="주소" /> <label
								for="floatingInput">주소</label>
						</div>						
						<button type="button" id="mgrSubmit" class="btn btn-success">등록</button>
