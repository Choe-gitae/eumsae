												...
												<table class="table">
													...
													<tbody>
														...
														<tr class="alert" role="alert">
															<td>
																<div class="img" style="background-image: url(<%=pjName%>/resources/lpImg/${lpVO.cjpg}.jpg);"></div>
															</td>
															<td>
																<div class="email">
															...
															<td class="quantity">
																<span class="input-group">
																	<input class="amount form-control input-number" type="text" name="amount" value="${lpVO.amount}" min="1" readonly>
																</span>
															</td>
