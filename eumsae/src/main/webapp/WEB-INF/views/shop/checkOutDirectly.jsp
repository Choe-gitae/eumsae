          ...
          <div class="col-xl-10 ftco-animate">
            ...
            <div class="row align-items-end">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="firstname">이름</label>
                  <input type="text" class="form-control" id="re_name" placeholder="" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="phone">전화번호</label>
                  <input type="text" class="form-control" id="re_pNum" placeholder="" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="emailaddress">우편번호</label>
                  <input id="sample6_postcode" type="text" class="form-control" placeholder="" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="sample6_address" type="text" class="form-control" placeholder="" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                          ...
                          <tr class="alert" role="alert">
                            <td>
                              <div
                                class="img"
                                style="
                                  background-image: url(<%=pjName%>/resources/lpImg/${lpVO.cjpg}.jpg);
                                "
                              ></div>
                            </td>
                            <td>
                              <div class="email">
                                <span>${lpVO.singer}</span> <span>${lpVO.title}</span>
                              </div>
                            </td>
                            <td>₩<span class="price">${lpVO.price}</span></td>
                            <td class="quantity">
                              <span class="input-group">
                                <input
                                  class="amount form-control input-number"
                                  type="text"
                                  name="amount"
                                  value="${lpVO.amount}"
                                  min="1"
            ...
            >
              ...
              <input type="hidden" name="lpno" id="lpno" value="${linfo.lpno}" />
            </form>
            <!-- END -->
            ...
            <div class="row mt-5 pt-3 d-flex">
              <div class="col-md-6 d-flex">
                <div class="cart-detail cart-total p-3 p-md-4">
                  ...
                  <p class="d-flex"><span>주문금액</span> <span class="subTp"></span></p>
                  <p class="d-flex"><span>배송비</span> <span id="dTax"></span></p>
                  <!-- <p class="d-flex">
									<span>할인</span> <span></span>
								</p> -->
                  <hr />
                  <p class="d-flex total-price"><span>결제하실 금액</span> <span id="tP"></span></p>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="cart-detail p-3 p-md-4">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <button class="btn btn-primary py-3 px-4" id="kakaoPay">
                        <img src="../resources/images/payment/payment_icon_yellow_medium.png" />
                      </button>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      <button class="btn btn-primary py-3 px-4" id="tossPay">
                        <img src="../resources/images/payment/tosspay.png" />
                      </button>
                    </div>
                  </div>
                </div>
