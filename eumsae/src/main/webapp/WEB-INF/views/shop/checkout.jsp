                            ...
                            <tr class="alert" role="alert">
                              <td>
                                <div
                                  class="img"
                                  style="
                                    background-image: url(<%=pjName%>/resources/lpImg/${linfo.cjpg}.jpg);
                                  "
                                ></div>
                              </td>
                              <td>
                              ...
                              <td class="quantity">
                                <span class="input-group">
                                  ...
                                  <input
                                    ...
                                    min="1"
                                    max="100"
                                    style="text-align-last: center; width: 30px"
                                    readonly
                                  />
                                  <button
                                    type="button"
            ...
            <div class="row mt-5 pt-3 d-flex">
              <div class="col-md-6 d-flex">
                <div class="cart-detail cart-total p-3 p-md-4">
                  ...
                  <p class="d-flex"><span>주문금액</span> <span class="resultPrice"></span></p>
                  <p class="d-flex"><span>배송비</span> <span class="delivery-tax"></span></p>
                  <!-- <p class="d-flex">
              ...
              <div class="col-md-6">
                <div class="cart-detail p-3 p-md-4">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <button class="btn btn-primary py-3 px-4" onclick="requestPaykakao()">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <button class="btn btn-primary py-3 px-4" onclick="requestPaytoss()">
