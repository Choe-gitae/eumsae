				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						<div class="single_product_desc">
							...
							<!-- Add to Cart Form -->
							<form class="cart clearfix" method="post" name="checkOutDirectly" action="checkOut?page=checkout">
								<div class="cart-btn d-flex mb-50">
									<p>Qty</p>
									<div class="quantity">
										<span class="qty-minus"><i class="fa fa-caret-down" aria-hidden="true"></i></span> 
										<input type="number" class="qty-text" id="qty" step="1" min="1" name="quantity" value="1" readonly> 
										<span class="qty-plus"><i class="fa fa-caret-up" aria-hidden="true"></i></span>
									</div>
								</div>
								...
								<button type="button" id="checkOut" name="checkout" class="btn btn-dark">check out</button>								
								
								<button type="button" id= "addToCart" name="addtocart" value="5"
