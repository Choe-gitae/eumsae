                        ...
                        <div class="login-form">
                            <form action="login" name='loginForm' method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control-my"  name="id" id="login_id" placeholder="아이디를 입력하세요...">
                                </div>
                                <div class="form-group">
                                    <label for="login_pwd">비밀번호</label>
                                    <input type="password" class="form-control-my" name="pwd" id="login_pwd" placeholder="비밀번호를 입력하세요..."><br/><br/>
