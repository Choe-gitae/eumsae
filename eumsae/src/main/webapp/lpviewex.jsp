					...
					<div class="single-blog-post mb-100 wow fadeInUp"
						...
						<div class="song-play-area">
							...
							<audio preload="auto" controls>
								<source src="resources/audio/smells_like_teen_sprit_nirvana.mp3"
									type="audio/mp3">
								<!--  눌렀을 때 , 음원 src 변경 필요 -->
							</audio>
						</div>
						...
						<div class="blog-content">
							...
							<div class="post-meta d-flex mb-30">
								...
								<!-- Post Excerpt -->
								<p class="post-meta">나랏말싸미 듕귁에 달아 서로 사맛디 아니할수ㅖ 이를 니르고져 홇쀄이셔도.</p> <!--  LP 내용 -->
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-lg-4">
						<div class="blog-sidebar-area">
							...
							<form name='frm' action="cart.do">
								...
								<br> <input type='submit' class='btn' value='장바구니'>
							</form>
						</div>
					</div>
				</div>
