		...
		<div class="hero-slides owl-carousel">
			...
			<div
				...
				<div class="slide-img bg-img"
					style="background-image: url(resources/img/bg-img/bg-000.gif);"></div>
				<!-- Slide Content -->
				<div class="container">
					<div class="row">
						<div class="col-12">
			...
			<div
				...
				<!-- Slide Img -->
				<div class="slide-img bg-img"
					style="background-image: url(resources/img/bg-img/bg-002.gif);"></div>
				<!-- Slide Content -->
				<div class="container">
					<div class="row">
						<div class="col-12">
			...
			<div
				...
				<!-- Slide Img -->
				<div class="slide-img bg-img"
					style="background-image: url(resources/img/bg-img/bg-003.gif);"></div>
				<!-- Slide Content -->
				<div class="container">
					<div class="row">
						<div class="col-12">
